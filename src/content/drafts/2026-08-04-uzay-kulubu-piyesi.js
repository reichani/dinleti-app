...
Kulüp ertesi hafta için yeni bir soru seçti. Kuyruklu yıldızların izleri neden uzundu? Gökyüzü haritasında yeni bir boşluk açıldı.`,
  ...
  metadata: {
    ...
    contentTrack: "role-reading-science",
    contentStatus: "draft",
    structuralValid: true,
    releaseReady: false,
    sourceType: "original-science-role-play",
    ...
    glossary: [
      ...
      { word: "gezegen", definition: "Bir yıldızın çevresinde dolanan büyük gök cismi." },
