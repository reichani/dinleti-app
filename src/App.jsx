...
const KATALOG = mergePilotStories([
  ...
  },
  {
    ...
    puan: 4.8,
    sureDk: 4.4,
    ozet: "Farklılık, dayanışma ve dürüstlük üzerine üç tamamlanmış Andersen uyarlaması.",
    sourceType: "public-domain-short-adaptation",
    sourceUrl: "https://www.gutenberg.org/ebooks/27200",
    adaptationScope: "Kamu malı İngilizce kaynaklardan özgün, kısaltılmış Türkçe yeniden anlatım; tam metin veya doğrudan çeviri değildir.",
    releaseReady: false,
    ...
    bolumler: [
      { ad: "Çirkin Ördek Yavrusu", dk: 1.3, metin: `Yaz başında çiftlikteki ördek yuvası canlandı. Yumurtalar sabah güneşiyle birer birer çatladı. Sarı yavrular annelerine sokulup neşeyle öttü. Yalnız iri yumurta sessizce bekliyordu.

Sonunda kabukta küçük bir çatlak belirdi. İçinden uzun boyunlu, gri bir yavru çıktı. Diğerlerinden daha büyük ve daha sakindi. Anne ördek onu dikkatle kanadının altına aldı.

Yavrular ertesi gün gölete yürüdü. Gri yavru suya girince güzelce yüzdü. Buna rağmen çiftliktekiler görünüşüyle alay etti. Yavru her sözde biraz daha yalnızlaştı.

Bir akşam çitin dışına doğru yürüdü. Sazlıkta yabani ördeklerle birkaç gün kaldı. Sonra sert rüzgârlar başladı ve göl dondu. Bir çiftçi onu buzdan kurtarıp evine götürdü.

Ev sıcaktı fakat yavru korkuyordu. Çocuklar yaklaşınca telaşla kanat çırptı. Bir kabı devirdi ve kapıdan kaçtı. Kışı çalılıkların arasında güçlükle geçirdi.

Bahar geldiğinde güneş toprağı yeniden ısıttı. Yavru, gökyüzünde beyaz kuşlar gördü. Onlara yaklaşmak istedi fakat çekindi. Yine de göle doğru yavaşça ilerledi.

Suda kendi görüntüsüyle karşılaşınca şaşkın kaldı. Gri tüylerinin yerinde beyaz tüyler vardı. Uzun boynu ışığın altında zarifçe kıvrılıyordu. O artık genç bir kuğuydu.

Diğer kuğular onu sessizce aralarına aldı. Çocuklar göl kıyısından yeni kuğuyu selamladı. Genç kuğu başını utangaçça eğdi. Yaşadığı günleri hiç unutmadı.

Farklı görünmesi bir kusur değildi. Yalnızca büyümek için zamana ihtiyacı vardı. Gölde ilerlerken kanatlarını güvenle açtı. Kendi yerini sonunda bulmuştu.` },
      { ad: "Kibritçi Kız", dk: 1.5, metin: `Yılın son akşamında kar sessizce yağıyordu. Sokak lambaları beyaz kaldırımları aydınlatıyordu. Küçük kız elindeki kibrit kutularını taşıyordu. Bütün gün yalnızca birkaç kutu satabilmişti.

Ayakkabıları koşarken ayağından çıkmıştı. İnce çorapları kar suyuyla ıslanmıştı. Eve eli boş dönmekten korkuyordu. Bu yüzden bir evin girintisine sığındı.

Pencerelerden sıcak yemek kokuları geliyordu. İçeride aileler yeni yılı bekliyordu. Kızın elleri soğuktan uyuşmuştu. Bir kibrit yakmaya karar verdi.

İlk alev küçük bir soba gibi parladı. Kız ellerini ışığa doğru uzattı. Sıcaklık gerçekmiş gibi yüzünü yumuşattı. Kibrit sönünce duvar yine karşısındaydı.

İkinci kibriti dikkatle yaktı. Bu kez kurulmuş bir sofra gördü. Masada sıcak çorba ve ekmek vardı. Alev bitince görüntü de kayboldu.

Üçüncü kibritte ışıklı bir ağaç belirdi. Dallarında renkli süsler parlıyordu. Kız ağaca yaklaşmak istedi. Fakat ışıklar gökyüzüne yükseldi.

Yukarıda parlak bir yıldız kaydı. Büyükannesinin sözlerini hatırladı. Kayan yıldızın bir vedayı anlattığını söylerdi. Kız büyükannesini çok özlemişti.

Yeni kibriti yakınca büyükanne karşısında belirdi. Yüzünde tanıdık ve sıcak gülümsemesi vardı. Kız görüntünün kaybolmasını istemedi. Kalan kibritleri peş peşe yaktı.

Işıklar bütün köşeyi gündüz gibi aydınlattı. Kız, büyükannesinin sevgisini yanında hissetti. Soğuk sokak bir an uzaklaştı. Hayalinde güvenli bir yere yürüdü.

Sabah olduğunda insanlar küçük kızı buldu. Yanında yanmış kibritler duruyordu. Kimse onun gördüğü sıcak görüntüleri bilmiyordu. Şehir o gün sessizce uyandı.

Komşular bu yalnızlığı geç fark etmişti. Bir daha çocukları görmezden gelmemeye karar verdiler. Mahallede sıcak yemek ve barınma ağı kurdular. Kızın anısı dayanışmaya dönüştü.` },
      { ad: "Kralın Yeni Giysileri", dk: 1.6, metin: `Uzak bir ülkede giysileri çok seven kral yaşardı. Her saat başka bir ceket giyerdi. Halkın sorunlarından çok aynaları düşünürdü. Sarayın dolapları renkli kumaşlarla doluydu.

Bir gün iki düzenbaz saraya geldi. Dünyanın en özel kumaşını dokuduklarını söylediler. Bu kumaşı yalnız bilgeler görebilirdi. Görevine uygun olmayanlar onu göremezdi.

Kral bu sözleri duyunca heyecanlandı. Hem güzel giyinecek hem insanları sınayacaktı. Düzenbazlara altın ve ipek verdi. Onlar boş tezgâhların başına oturdu.

Mekikleri çalıştırıyor gibi ellerini hareket ettirdiler. Gerçekte tezgâhlarda hiçbir şey yoktu. İlk denetim için yaşlı bakan geldi. Boş çerçeveye bakınca yüzü soldu.

Kumaşı göremediğini söylemeye cesaret edemedi. Renklerin eşsiz olduğunu söyledi. Desenleri uzun uzun övdü. Kral bu habere çok sevindi.

Sonra başka görevliler tezgâhı ziyaret etti. Onlar da boşluğu gördü fakat sustu. Kimse bilgisiz sanılmak istemiyordu. Böylece ortak bir yalan büyüdü.

Tören günü düzenbazlar görünmez giysiyi taşıdı. Kralın üstündeki eski kıyafetleri çıkardılar. Hayalî ceketi dikkatle giydiriyormuş gibi yaptılar. Saraylılar hayranlık sözleri sıraladı.

Kral büyük geçit için sokağa çıktı. Halk söylentiyi önceden duymuştu. Herkes görünmeyen giysiyi övmeye başladı. Sessizlikte yalnız küçük bir çocuk düşündüğünü söyledi.

Kralın üzerinde hiçbir şey olmadığını açıkladı. Önce babası çocuğu susturmak istedi. Sonra söz kalabalıkta yayıldı. İnsanlar gerçeği birbirine fısıldadı.

Kral aynalı bir dükkânın önünden geçti. Çocuğun doğru söylediğini sonunda anladı. Utandı fakat yürümeyi sürdürmek istemedi. Durdu ve töreni sona erdirdi.

Düzenbazlar altınlarla şehirden kaçmıştı. Kral halktan özür diledi. Bakanlar korktukları için sustuklarını anlattı. Sarayda yeni bir kural kondu.

Kimse dürüst sözü yüzünden cezalandırılmayacaktı. Kararlar açık toplantılarda konuşulacaktı. Kral daha sade giysiler seçmeye başladı. Aynalardan çok halkın sesini dinledi.` },
    ],
  },
  {
    id: "ezop-masallari",
