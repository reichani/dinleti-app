...
import { YAGMUR_TIP_TIP_DRAFT } from "../../src/content/drafts/2026-08-31-yagmur-tip-tip.js";

const story = YAGMUR_TIP_TIP_DRAFT;
...
test("Yağmur Tıp Tıp yaş, süre ve bölüm sözleşmesini karşılar", () => {
...
test("Yağmur Tıp Tıp dil, paragraf ve tamamlanmış anlatı sözleşmesini korur", () => {
...
test("Yağmur Tıp Tıp insan onayı olmadan yayın-ready değildir", () => {
