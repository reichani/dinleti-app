...
import { MOON_NOT_STAR_EN_DRAFT as story } from '../../src/content/drafts/2026-09-09-moon-not-star-en.js';
...
function validate(candidate) {
  ...
  const errors = [];
  if (candidate.language !== 'en' || candidate.ageBand !== '10-12' || candidate.readingPathId !== 'akici_okuma_10_12' || count < 700 || count > 1200) errors.push('age-language');
...
test('The Moon Is Not a Star satisfies ages 10–12 structure, timing and language gates', () => {
...
test('factual provenance remains explicit and every human review stays pending', () => {
...
test('negative fixtures reject every mandatory release blocker class', () => {
  const cases = [
    ['age-language', value => { value.ageBand = '8-10'; }],
