...
import { ELA_EL_ELE_DRAFT } from "../../src/content/drafts/2026-08-28-ela-el-ele.js";

const story = ELA_EL_ELE_DRAFT;
...
test("Ela El Ele: yaş, gerçek süre ve anlamlı bölüm sözleşmesi", () => {
...
test("Ela El Ele: cümle, paragraf, sözlük ve anlatı sözleşmesi", () => {
...
test("Ela El Ele: özgünlük izi açık, insan onayı olmadan release kapalı", () => {
