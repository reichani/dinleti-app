...
import { BIR_TOHUMUN_YOLCULUGU_DRAFT } from "../../src/content/drafts/2026-07-30-bir-tohumun-yolculugu.js";
...
test("Bir Tohumun Yolculuğu: yaş, süre ve bölüm sözleşmesi", () => {
...
test("Bir Tohumun Yolculuğu: dil, paragraf, sözlük ve tema sözleşmesi", () => {
...
test("Bir Tohumun Yolculuğu: kaynak ve insan onayı olmadan yayımlanamaz", () => {
