...
import { BIR_TOHUMUN_YOLCULUGU_DRAFT as story } from '../../src/content/drafts/2026-09-25-bir-tohumun-yolculugu.js';
...
test('Bir Tohumun Yolculuğu yaş, süre, bölüm ve dil sözleşmesini karşılar', () => {
