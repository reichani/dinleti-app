...
import { AESOPS_FABLES_DRAFT as story } from '../../src/content/drafts/2026-09-16-aesops-fables.js';
...
test('Aesop draft meets 6–7 length, section, duration and language bounds', () => {
...
test('adaptation scope is explicit and publication remains human-blocked', () => {
  ...
  assert.ok(story.sourceTruth.sourceUrls.length);
  assert.match(story.sourceTruth.scope, /not a complete reproduction/u);
