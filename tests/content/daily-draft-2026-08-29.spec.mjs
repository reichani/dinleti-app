...
import { OKI_EL_ELE_DRAFT } from "../../src/content/drafts/2026-08-29-oki-el-ele.js";

const story = OKI_EL_ELE_DRAFT;
...
test("Oki El Ele: yaş, gerçek süre ve anlamlı bölüm sözleşmesi", () => {
...
test("Oki El Ele: cümle, paragraf, sözlük ve anlatı sözleşmesi", () => {
...
test("Oki El Ele: özgünlük izi açık, insan onayı olmadan release kapalı", () => {
