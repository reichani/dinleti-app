...
import { SELFISH_GIANT_DRAFT as story } from '../../src/content/drafts/2026-09-19-selfish-giant.js';
...
test('Selfish Giant draft meets 10–12 length, section, duration and language bounds', () => {
...
test('adaptation scope is explicit and publication remains human-blocked', () => {
  ...
  assert.match(story.sourceTruth.scope, /final religious allegory/u);
