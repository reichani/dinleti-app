...
import { BIR_TOHUMUN_YOLCULUGU_DRAFT } from "../../src/content/drafts/2026-08-25-bir-tohumun-yolculugu.js";

const story = BIR_TOHUMUN_YOLCULUGU_DRAFT;
...
test("Tohum: yaş, gerçek süre ve anlamlı bölüm sözleşmesi", () => {
  ...
  assert.equal(story.ageBand, "8-10");
  assert.equal(story.readingPathId, "okuma_guveni_8_10");
  assert.ok(actualWords >= 500 && actualWords <= 900);
...
test("Tohum: cümle, paragraf, sözlük ve tema sözleşmesi", () => {
...
test("Tohum: kaynak izi açık, insan onayı olmadan release kapalı", () => {
