...
import { ARILAR_NEDEN_DANS_EDER_DRAFT } from "../../src/content/drafts/2026-08-24-arilar-neden-dans-eder.js";
...
test("Arılar: yaş, gerçek süre ve anlamlı bölüm sözleşmesi", () => {
  ...
  assert.equal(story.ageBand, "10-12");
  assert.equal(story.readingPathId, "akici_okuma_10_12");
...
test("Arılar: cümle, paragraf, sözlük ve tema sözleşmesi", () => {
...
test("Arılar: kaynak izi açık, insan onayı olmadan release kapalı", () => {
