...
import { SPACE_POEM_EN_DRAFT as story } from '../../src/content/drafts/2026-09-07-space-poem-en.js';
...
test('Space Poem satisfies ages 10–12 structure, timing and language gates', () => {
...
test('Space Poem keeps factual provenance and all human reviews pending', () => {
...
test('negative fixtures reject mandatory blocker classes', () => {
  const cases = [
    ['age-language', value => { value.sections = value.sections.slice(0, 2); }],
