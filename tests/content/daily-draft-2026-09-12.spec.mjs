...
import { YUKSEK_OKCELER_DRAFT as story } from '../../src/content/drafts/2026-09-12-yuksek-okceler.js';
...
test('Yüksek Ökçeler 10–12 yaş yapı, süre ve dil kapılarını karşılar', () => {
...
test('uyarlama kapsamı açık, bütün insan kapıları beklemede', () => {
  assert.equal(story.sourceTruth.adaptationStatus, 'short-adaptation');
  assert.match(story.sourceTruth.scope, /tam metin.*değildir/i);
